...
export const defaultSiteContent: SiteContent = {
  ...
  guide: {
    ...
    pageIntro:
      "Halaman ini berisi panduan penulisan dan pengumpulan artikel untuk Seminar Nasional DATAMATIKA 2026, termasuk checklist submit, alur pendaftaran, template artikel, dan informasi biaya pendaftaran.",
    editorialSections: [
      {
        heading: "Panduan Penulis",
        body:
          "Penulis diundang untuk mengirimkan naskah ke prosiding ini. Setiap naskah akan ditinjau terlebih dahulu oleh editor untuk memastikan kesesuaian dengan fokus dan ruang lingkup seminar. Naskah yang dinilai sesuai akan dilanjutkan ke proses peer review sebelum diputuskan diterima atau ditolak.\n\nSebelum mengirim naskah, penulis bertanggung jawab memperoleh izin untuk mempublikasikan semua materi yang disertakan (misalnya foto, dokumen, atau dataset). Semua penulis yang dicantumkan wajib menyetujui pencantuman namanya sebagai penulis. Jika diperlukan, penelitian harus telah mendapatkan persetujuan dari komite etik yang berwenang sesuai ketentuan hukum negara tempat penelitian dilakukan.\n\nEditor dapat menolak naskah pada tahap awal (desk reject) jika tidak memenuhi standar mutu minimum. Pastikan rancangan studi dan argumen penelitian disusun serta dijelaskan dengan baik. Judul harus ringkas, dan abstrak harus mampu berdiri sendiri. Hal ini meningkatkan peluang naskah disetujui reviewer untuk ditelaah.",
        bullets: [],
      },
      {
        heading: "Checklist Persiapan Submit",
        body: "Semua pengiriman naskah wajib memenuhi persyaratan berikut:",
        bullets: [
          "Naskah telah memenuhi ketentuan dalam Panduan Penulis.",
          "Naskah belum pernah dipublikasikan dan tidak sedang diajukan ke jurnal/prosiding lain.",
          "Seluruh referensi telah diperiksa akurasi dan kelengkapannya.",
          "Semua tabel dan gambar telah diberi nomor serta label yang jelas.",
          "Izin publikasi untuk foto, dataset, atau materi pendukung lainnya telah diperoleh.",
        ],
      },
      {
        heading: "Pernyataan Privasi",
        body:
          "Nama dan alamat email yang dimasukkan pada situs ini hanya digunakan untuk kebutuhan Konferensi/Prosiding DATAMATIKA 2026 dan tidak akan digunakan untuk tujuan lain maupun dibagikan ke pihak lain.",
        bullets: [],
      },
    ],
